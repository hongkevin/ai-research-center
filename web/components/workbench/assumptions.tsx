    ...
    <RailSection title="추정 가정" count={`${shown}개년`} defaultOpen>
      <Card>
        <CardContent className="py-3">
          ...
          {/* **손으로 고친 문장이 사라진다는 것을 미리 말한다.** 전에는
              「본문도 다시 쓰이고」라고만 했는데, 그 말로는 자기가 다듬은
              문장이 버려진다는 것을 알 수 없다. 잃은 것은 수정 이력에서
              볼 수 있다 — 그것도 이번에 채웠다. */}
          <Hint>
            <b className="text-warn">본문이 처음부터 다시 쓰입니다.</b> 직접
            고치신 문장이 있으면 그것도 함께 사라집니다 — 지운 내용은 수정
            이력에 남으니 필요하면 거기서 보고 다시 쓰십시오.
          </Hint>
